...
export const CHECKLIST_DEFAULTS: Omit<ChecklistItem, 'id' | 'project_id' | 'checked_by_client' | 'checked_by_admin' | 'note' | 'file_url' | 'admin_note' | 'client_question' | 'admin_question_reply'>[] = [
